/*
 * ((e)) emite: A pure gwt (Google Web Toolkit) xmpp (jabber) library (c) 2008-2009 The emite
 * development team (see CREDITS for details) This file is part of emite. This program is free
 ...
 * FOR A PARTICULAR PURPOSE. See the GNU Lesser General Public License for more details. You should
 * have received a copy of the GNU Lesser General Public License along with this program. If not,
               ...
               final SessionComponentsRegistry registry )
   {
      ...
      connection.addStanzaReceivedHandler( new StanzaHandler()
      {
         ...
         public void onStanza( final StanzaEvent event )
         {
            ...
            else if( credentials != null && ( "stream:features".equals( name ) || "features".equals( name ) )
               && stanza.hasChild( "mechanisms" ) )
            {
